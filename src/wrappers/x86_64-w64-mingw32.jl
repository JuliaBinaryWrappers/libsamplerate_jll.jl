# Autogenerated wrapper script for libsamplerate_jll for x86_64-w64-mingw32
...
const libsamplerate_splitpath = ["bin", "libsamplerate-0.dll"]
...
const libsamplerate = "libsamplerate-0.dll"


# Relative path to `sndfile_resample`
const sndfile_resample_splitpath = ["bin", "sndfile-resample.exe"]
