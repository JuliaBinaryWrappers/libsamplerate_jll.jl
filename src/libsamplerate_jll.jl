...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libsamplerate_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9427e74d-4e05-59c1-8ff3-7d74b6e52ac8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libsamplerate", artifacts_toml) for e in artifacts["libsamplerate"]]
...
if best_platform === nothing
    @debug("Unable to load libsamplerate; unsupported platform $(triplet(platform_key_abi()))")
else
